...
| # | Task | Assigned To | Comments |
|---|------|-------------|----------|
| 1 | Kickoff: assign roles, review requirements.md and Alex Kim's persona/objective, agree on tech stack | Ashish/Kartik/Pratik | Held kickoff call; reviewed requirements.md and Week 1 tasks; roles and ownership split across Ashish, Kartik, and Pratik. |
| 2 | Set up the git repository: initialize repo, agree on branch strategy, add .gitignore, write a README | Ashish | Done, shared the repo with the group |
| 3 | Draft the system prompt: triage-copilot tone and the "no autonomous production actions" rule | Pratik/Ashish | |
